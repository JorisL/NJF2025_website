...
Op deze toestemmingsbrief zijn de Algemene Voorwaarden, te vinden op nederlandsjongleerfestival.nl, van toepassing.
]
...
Voor jongeren die bij aanvang van het festival jonger dan 18 jaar oud zijn dient één van de ouders/verzorgers toestemming te geven voor deelname middels ondertekening van dit formulier. Voor deelnemers die bij aanvang van het festival jonger dan 16 jaar zijn dient tevens een begeleidende deelnemer aangewezen te worden die bij aanvang van het festival minimaal 18 jaar is.
Deze begeleidende deelnemer dient aanwezig te zijn gedurende de volledige periode dat het betreffende kind aanwezig is op het festival.
...
#grid(
  ...
  [#stack(
    dir: ttb,
    [*Gegevens begeleider* #footnote[Deze velden dienen enkel ingevuld te worden voor deelnemers die op de startdatum van het festival jonger dan 16 jaar zijn] <fn_begeleider>],
    [#v(15pt)],
    [Naam:],
    [#v(30pt)],
    [#form_line],
